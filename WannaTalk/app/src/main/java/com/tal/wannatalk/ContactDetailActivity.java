...
/**
 * This class defines a simple FragmentActivity as the parent of ContactDetailFragment.
 */
...
//Tal            final Uri uri = getIntent().getData();
...
//Tal            if (getSupportFragmentManager().findFragmentByTag(TAG) == null) {
